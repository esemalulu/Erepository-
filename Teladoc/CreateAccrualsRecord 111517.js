     ...
     if (todays_date == last_date)
     {
       ...
       { 
           ...
           { 
               ...
               var expensedept      = results.getValue(columns[18]);
               var currency         = results.getValue(columns[19]);
	           ...
	           record.setFieldValue('custrecord_liv_accruals_expense_acct',expenseacct) ;
	           ...
	           record.setFieldValue('custrecord_liv_accruals_expense_dept', expensedept) ;
