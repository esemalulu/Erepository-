...
function CreateInvoice()
{
 try
 {
  ...
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_wm_upfront_item'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_wm_upfront_item_d'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_wm_upfront_meter_qty'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_wm_upfront_price'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_wm_upfront_amt'));
  ...
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_upfront_item'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_upfront_item_d'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dpp_upfront_meter_qty'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_upfront_price'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dpp_upfront_amt'));
  
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_wp_upfront_item'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_wp_upfront_item_de'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_wp_upfront_meter_q'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_wp_upfront_price'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_dpp_wp_upfront_amt'));
  ...
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_bh2_term_item'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_bh2_term_item_desc'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_bh2_earlyterm_qty'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_bh2_term_price'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_bh2_term_amt'));  
...
/********************************************************************************************/
{
	nlapiLogExecution('DEBUG', 'ACTIVITY', 'createInvoiceRec Started...');
       ...
       //Tax Line
        ...
        var wmupfrontitem = customrecord.getValue('custrecord_bs2_ns_wm_upfront_item');
        var wmupfrontitemdesc = customrecord.getValue('custrecord_bs2_ns_wm_upfront_item_d');
        var wmupfrontqty = customrecord.getValue('custrecord_bs2_wm_upfront_meter_qty');
        var wmupfrontprice = customrecord.getValue('custrecord_bs2_ns_wm_upfront_price');
        var wmupfrontamt = customrecord.getValue('custrecord_bs2_wm_upfront_amt');
        ...
        var dppupfrontitem = customrecord.getValue('custrecord_bs2_ns_dpp_upfront_item');
        var dppupfrontitemdesc = customrecord.getValue('custrecord_bs2_ns_dpp_upfront_item_d');
        var dppupfrontqty = customrecord.getValue('custrecord_bs2_dpp_upfront_meter_qty');
        var dppupfrontprice = customrecord.getValue('custrecord_bs2_ns_dpp_upfront_price');
        var dppupfrontamt = customrecord.getValue('custrecord_bs2_dpp_upfront_amt');
        
        var dppwpupfrontitem = customrecord.getValue('custrecord_bs2_ns_dpp_wp_upfront_item');
        var dppwpupfrontitemdesc = customrecord.getValue('custrecord_bs2_ns_dpp_wp_upfront_item_de');
        var dppwpupfrontqty = customrecord.getValue('custrecord_bs2_ns_dpp_wp_upfront_meter_q');
        var dppwpupfrontprice = customrecord.getValue('custrecord_bs2_ns_dpp_wp_upfront_price');
        var dppwpupfrontamt = customrecord.getValue('custrecord_bs2_ns_dpp_wp_upfront_amt');
        ...
        var bh2ptmitem = customrecord.getValue('custrecord_bs2_bh2_term_item');
        var bh2ptmitemdesc = customrecord.getValue('custrecord_bs2_bh2_term_item_desc');
        var bh2ptmqty = customrecord.getValue('custrecord_bs2_bh2_earlyterm_qty');
        var bh2ptmprice = customrecord.getValue('custrecord_bs2_bh2_term_price');
        var bh2ptmamt = customrecord.getValue('custrecord_bs2_bh2_term_amt');
		...
		try
		{
		 ...
		 if (nvl(totalbillingamt,0) > 0)
	     {
            ...
            if (nvl(bh2ptmqty,0) > 0)
                {
                   record.selectNewLineItem('item');
    	           record.setCurrentLineItemValue('item','item',bh2ptmitem);
                   record.setCurrentLineItemValue('item', 'description', appendClientCode(bh2ptmitemdesc, ccgrouping));
                   record.setCurrentLineItemValue('item', 'quantity', bh2ptmqty);
                   record.setCurrentLineItemText('item', 'price', 'Custom'); //101718
                   record.setCurrentLineItemValue('item', 'rate', nvl(bh2ptmprice,0));
                   record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                   record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                   record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                   record.commitLineItem('item');
...
//Begin Alex
             ...
             if (nvl(bundleqty,0) > 0)
            {
              ...
              // if (nvl(cbdiscountprice,'NA') != 'NA')
               if (cbdiscountprice != 0)
               {
                  ...
                  var calciulatedRate = nvl(cbdiscountamt,0)/bundleqty;
                  record.setCurrentLineItemValue('item', 'rate', nvl(calciulatedRate,0));
               ...
               else
               {
                  ...
                  if (cbdiscountamt != 0) //dm & htn
                  {
                      ...
                      var calciulatedRate = nvl(cbdiscountamt,0)/cbprogqty;
                      record.setCurrentLineItemValue('item', 'rate', nvl(calciulatedRate,0));
                  ...
                  if (dmwmdiscountamt != 0) //dm & wm
                  {
                      ...
                      var calciulatedRate = nvl(dmwmdiscountamt,0)/dmwmprogqty;
                      record.setCurrentLineItemValue('item', 'rate', nvl(calciulatedRate,0));
                  ...
                  if (dpphtndiscountamt != 0) //dpp & htn
                  {
                      ...
                      var calciulatedRate = nvl(dpphtndiscountamt,0)/dpphtnprogqty;
                      record.setCurrentLineItemValue('item', 'rate', nvl(calciulatedRate,0));
                  ...
                  if (nvl(dmhtnwmdiscountamt,0) != 0) //dm & htn & wm
                  {
                      ...
                      var calciulatedRate = nvl(dmhtnwmdiscountamt,0)/dmhtnwmprogqty;
                      record.setCurrentLineItemValue('item', 'rate', nvl(calciulatedRate,0));
    ...
    //End Alex
	        ...
	        // Upfront Meter
              ...
              if (nvl(wmupfrontqty,0) > 0)
	          {
                 record.selectNewLineItem('item');
	             record.setCurrentLineItemValue('item','item',wmupfrontitem);
                 record.setCurrentLineItemValue('item', 'description', appendClientCode(wmupfrontitemdesc, ccgrouping));
                 record.setCurrentLineItemValue('item', 'quantity', wmupfrontqty);
                 record.setCurrentLineItemText('item', 'price', 'Custom');
                 record.setCurrentLineItemValue('item', 'rate', nvl(wmupfrontprice,0) );
                 record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                 record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                 record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                 record.commitLineItem('item');
              ...
              if (nvl(dppupfrontqty,0) > 0)
	          {
                 record.selectNewLineItem('item');
	             record.setCurrentLineItemValue('item','item',dppupfrontitem);
                 record.setCurrentLineItemValue('item', 'description', appendClientCode(dppupfrontitemdesc, ccgrouping));
                 record.setCurrentLineItemValue('item', 'quantity', dppupfrontqty);
                 record.setCurrentLineItemText('item', 'price', 'Custom');
                 record.setCurrentLineItemValue('item', 'rate', nvl(dppupfrontprice,0) );
                 record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                 record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                 record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                 record.commitLineItem('item');
              ...
              if (nvl(dppwpupfrontqty,0) > 0)
	          {
                 record.selectNewLineItem('item');
	             record.setCurrentLineItemValue('item','item',dppwpupfrontitem);
                 record.setCurrentLineItemValue('item', 'description', appendClientCode(dppwpupfrontitemdesc, ccgrouping));
                 record.setCurrentLineItemValue('item', 'quantity', dppwpupfrontqty);
                 record.setCurrentLineItemText('item', 'price', 'Custom');
                 record.setCurrentLineItemValue('item', 'rate', nvl(dppwpupfrontprice,0) );
                 record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                 record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                 record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                 record.commitLineItem('item');
	      ...
	      //DBT
	        ...
	        if(tier2JSONString.length > 0){
	        	...
	        	for(var z=0;z<tier2JSONObj.length;z++){
	        		...
	        		if(tier2JSONObj[z].program == 'Bundle Discount'){
	    	               ...
	    	               var calciulatedRate = nvl(tier2JSONObj[z].bundle_disc2_price,0)/tier2JSONObj[z].bundle_disc2_quantity;
	    	               record.setCurrentLineItemValue('item', 'rate', nvl(calciulatedRate,0));
	        ...
	        if(getPartnerAdminFeeFromRS == 'T'){
	            ...
	            if (nvl(wmreferralqty,0) > 0 && nvl(wmreferralrate,0) > 0 )
	            {
	                ...
	                record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
	                record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
	                record.setCurrentLineItemValue('item', 'custcol_is_wm_admin_fee', 'T');
	                record.commitLineItem('item');
	            }
