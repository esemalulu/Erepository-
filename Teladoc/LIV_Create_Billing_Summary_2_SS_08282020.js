    ...
    function calculateData(scriptContext, recIds){  	
    	...
    	//try{
	    	for(var j=0;j<recIds.length;j++){
		    	...
		    	//var rs_wp = 					rsRec.getValue({ fieldId: 'custrecord_rs_bh' });
		    	...
		    	//Tier-2
		    	/*if(rs_sku == 'dbt_phase2_upfront'){
		    		//log.debug('dbt2_upfront');
		    		dbt2_upfront_quantity = dbt2_upfront_quantity + rs_quantity;
		    		dbt2_upfront_rate = rs_rate;
		    		dbt2_upfront_price = dbt2_upfront_price + rs_price;
		    		isRowProcessed = true;
		    		isTier2SKU = true;
		    	}*/
		    	...
		    	//Tier-2
		    	/*if(rs_sku == 'htn_phase2_upfront'){
		    		//log.debug('htn2_upfront');
		    		htn2_upfront_quantity = htn2_upfront_quantity + rs_quantity;
					htn2_upfront_rate = rs_rate;
					htn2_upfront_price = htn2_upfront_price + rs_price;
					isRowProcessed = true;
					isTier2SKU = true;
		    	}	*/
		    	...
		    	if(rs_sku == 'htn_phase2_dbt_pppm' || rs_sku == 'htn_dbt_phase2_pppm' || rs_sku == 'htn_phase2_dbt_phase2_pppm'){
		    		...
		    		if(rs_htn == 1){
		    			...
		    			if (htn2_active_rate == 0.0)
	    				{
		    				if (rs_dbt == 1)
	    					{
	    						htn2_active_rate = comb_htn2_dbt2_rate - dbt2_active_rate;
	    					}
		    			}
		    		...
		    		if(rs_dbt == 1){
		    			...
		    			if (dbt2_active_rate == 0.0)
	    				{
		    				if (rs_htn == 1)
	    					{
	    						dbt2_active_rate = comb_htn2_dbt2_rate - htn2_active_rate;
	    					}
		    			}
		    	...
		    	if(rs_sku == 'wm_phase2_dbt_pppm' || rs_sku == 'wm_dbt_phase2_pppm' || rs_sku == 'wm_phase2_dbt_phase2_pppm'){
		    		...
		    		if(rs_wm == 1){
		    			...
		    			if (wm2_active_rate == 0.0)
	    				{
		    				if (rs_dbt == 1)
	    					{
	    						wm2_active_rate = comb_wm2_dbt2_rate - dbt2_active_rate;
	    					}
		    			}
		    		...
		    		if(rs_dbt == 1){
		    			...
		    			if (dbt2_active_rate == 0.0)
	    				{
		    				if (rs_wm == 1)
	    					{
		    					dbt2_active_rate = comb_wm2_dbt2_rate - wm2_active_rate;
	    					}
		    			}
						dbt2_active_price = dbt2_active_price + (rs_quantity*dbt2_active_rate);
		    		}
		    	...
		    	if(rs_sku == 'pd_phase2_dbt_pppm' || rs_sku == 'pd_dbt_phase2_pppm' || rs_sku == 'pd_phase2_dbt_phase2_pppm'){
		    		...
		    		if(rs_pd == 1){
		    			...
		    			if (pd2_active_rate == 0.0)
	    				{
		    				if (rs_dbt == 1)
	    					{
		    					pd2_active_rate = comb_pd2_dbt2_rate - dbt2_active_rate;
	    					}
		    			}
		    		...
		    		if(rs_dbt == 1){
		    			...
		    			if (dbt2_active_rate == 0.0)
	    				{
		    				if (rs_pd == 1)
	    					{
		    					dbt2_active_rate = comb_pd2_dbt2_rate - pd2_active_rate;
	    					}
		    			}
						dbt2_active_price = dbt2_active_price + (rs_quantity*dbt2_active_rate);
		    		}
		    	...
		    	if(rs_sku == 'dbt_bh_pppm'){
					...
					if(rs_dbt == 1){
		    			...
		    			if (dbt_active_rate == 0.0)
	    				{
		    				if (rs_bh == 1)
	    					{
		    					dbt_active_rate = comb_dbt_bh2_rate - bh2_active_rate;
	    					}
		    			}
						dbt_active_price = dbt_active_price + (rs_quantity*dbt_active_rate);
		    		}
		    		if(rs_bh == 1){
		    			...
		    			if (bh2_active_rate == 0.0)
	    				{
		    				if (rs_dbt == 1)
	    					{
		    					bh2_active_rate = comb_dbt_bh2_rate - dbt_active_rate;
	    					}
		    			}
		    	...
		    	if(rs_sku == 'htn_bh_pppm'){
					...
					if(rs_htn == 1){
		    			...
		    			if (htn_active_rate == 0.0)
	    				{
		    				if (rs_bh == 1)
	    					{
		    					htn_active_rate = comb_htn_bh2_rate - bh2_active_rate;
	    					}
		    			}
						htn_active_price = htn_active_price + (rs_quantity*htn_active_rate);
		    		}
		    		if(rs_bh == 1){
		    			...
		    			if (bh2_active_rate == 0.0)
	    				{
		    				if (rs_htn == 1)
	    					{
		    					bh2_active_rate = comb_htn_bh2_rate - htn_active_rate;
	    					}
		    			}
						bh2_active_price =bh2_active_price + (rs_quantity*bh2_active_rate);
		    		}		    	
		    	...
		    	if(rs_sku == 'wm_bh_pppm'){
					...
					if(rs_wm == 1){
		    			...
		    			if (wm_active_rate == 0.0)
	    				{
		    				if (rs_bh == 1)
	    					{
		    					wm_active_rate = comb_wm_bh2_rate - bh2_active_rate;
	    					}
		    			}
						wm_active_price = wm_active_price + (rs_quantity*wm_active_rate);
		    		}
		    		if(rs_bh == 1){
		    			...
		    			if (bh2_active_rate == 0.0)
	    				{
		    				if (rs_wm == 1)
	    					{
		    					bh2_active_rate = comb_wm_bh2_rate - wm_active_rate;
	    					}
		    			}
						bh2_active_price =bh2_active_price + (rs_quantity*bh2_active_rate);
		    		}		    	
		    	...
		    	if(rs_sku == 'pd_phase2_htn_pppm' || rs_sku == 'pd_htn_phase2_pppm' || rs_sku == 'pd_phase2_htn_phase2_pppm'){
		    		...
		    		if(rs_pd == 1){
		    			...
		    			if (pd2_active_rate == 0.0)
	    				{
		    				if (rs_htn == 1)
	    					{
		    					pd2_active_rate = comb_pd2_htn2_rate - htn2_active_rate;
	    					}
		    			}
						pd2_active_price = pd2_active_price + (rs_quantity*pd2_active_rate);
		    		}
		    		if(rs_htn == 1){
		    			...
		    			if (htn2_active_rate == 0.0)
	    				{
		    				if (rs_pd == 1)
	    					{
		    					htn2_active_rate = comb_pd2_htn2_rate - pd2_active_rate;
	    					}
		    			}
						htn2_active_price = htn2_active_price + (rs_quantity*htn2_active_rate);
		    		}
		    	...
		    	if(rs_sku == 'wm_phase2_pd_pppm' || rs_sku == 'wm_pd_phase2_pppm' || rs_sku == 'wm_phase2_pd_phase2_pppm'){
		    		...
		    		if(rs_wm == 1){
		    			...
		    			if (wm_active_rate == 0.0)
	    				{
		    				if (rs_pd == 1)
	    					{
		    					wm2_active_rate = comb_wm2_pd2_rate - pd2_active_rate;
	    					}
		    			}
						wm2_active_price = wm2_active_price + (rs_quantity*wm2_active_rate);
		    		}
		    		if(rs_pd == 1){
		    			...
		    			if (pd2_active_rate == 0.0)
	    				{
		    				if (rs_wm == 1)
	    					{
		    					pd2_active_rate = comb_wm2_pd2_rate - wm2_active_rate;
	    					}
		    			}
						pd2_active_price = pd2_active_price + (rs_quantity*pd2_active_rate);
		    		}
		    	...
		    	if(rs_sku == 'wm_phase2_htn_pppm' || rs_sku == 'wm_htn_phase2_pppm' || rs_sku == 'wm_phase2_htn_phase2_pppm'){
		    		...
		    		if(rs_wm == 1){
		    			...
		    			if (wm2_active_rate == 0.0)
	    				{
		    				if (rs_htn == 1)
	    					{
		    					wm2_active_rate = comb_wm2_htn2_rate - htn2_active_rate;
	    					}
		    			}
						wm2_active_price = wm2_active_price + (rs_quantity*wm2_active_rate);
		    		}
		    		if(rs_htn == 1){
		    			...
		    			if (htn2_active_rate == 0.0)
	    				{
		    				if (rs_wm == 1)
	    					{
		    					htn2_active_rate = comb_wm2_htn2_rate - wm2_active_rate;
	    					}
		    			}		    			
						htn2_active_price = htn2_active_price + (rs_quantity * htn2_active_rate);
		    		}
		    	...
		    	//WP - PD
		    	/*if(rs_sku == 'wp_pd_pppm' || rs_sku == 'wp_pdptm_pppm' || rs_sku == 'wpptm_pd_pppm' || rs_sku == 'wpptm_pdptm_pppm'){
		    		//log.debug('WM - PD');
		    		comb_wp_pd_quantity = comb_wp_pd_quantity + rs_quantity;
					comb_wp_pd_rate = rs_rate;
					comb_wp_pd_price = comb_wp_pd_price + rs_price;
					isRowProcessed = true;
					
		    		if(rs_wp == 1){
		    			//log.debug('rs_wp == 1');
		    			wp_active_quantity = wp_active_quantity + rs_quantity;
		    			wp_active_quantity_bundle = wp_active_quantity_bundle + rs_quantity;
		    			if (wp_active_rate == 0.0)
	    				{
		    				if (rs_pd == 1)
	    					{
		    					wp_active_rate = comb_wp_pd_rate - pd_active_rate;
	    					}
		    			}
						wp_active_price = wp_active_price + (rs_quantity*wp_active_rate);
		    		}
		    		if(rs_wp_ptm == 1){
		    			//log.debug('rs_wp_ptm == 1');
		    			wp_earlyterm_quantity = wp_earlyterm_quantity + rs_quantity;
						wp_earlyterm_price = wp_earlyterm_price + (rs_quantity*wp_earlyterm_rate);
		    		}
		    		if(rs_pd == 1){
		    			//log.debug('rs_pd == 1');
		    			pd_active_quantity = pd_active_quantity + rs_quantity;
		    			...
		    			if (pd_active_rate == 0.0)
	    				{
		    				if (rs_wp == 1)
	    					{
		    					pd_active_rate = comb_wp_pd_rate - wp_active_rate;
	    					}
		    			}
						pd_active_price = pd_active_price + (rs_quantity*pd_active_rate);
		    		}
			    	...
			    	if(rs_sku == 'wm_phase2_htn_dbt_pppm' || rs_sku == 'wm_htn_phase2_dbt_pppm' || rs_sku == 'wm_htn_dbt_phase2_pppm'
			    		...
			    		if(rs_wm == 1){
			    			...
			    			if (wm2_active_rate == 0.0)
		    				{
		    					...
		    					{
			    					if(htn2_active_rate > 0.0 && dbt2_active_rate > 0.0){
			    						wm2_active_rate = comb_wm2_htn2_dbt2_rate - (htn2_active_rate + dbt2_active_rate);	
			    					}
		    					}
			    			}
							wm2_active_price = wm2_active_price + (rs_quantity*wm2_active_rate);
			    		...
			    		if(rs_htn == 1){
			    			...
			    			if (htn2_active_rate == 0.0)
		    				{
			    				if (rs_wm == 1 && rs_dbt == 1)
		    					{
			    					if(wm2_active_rate > 0.0 && dbt2_active_rate > 0.0)
			    					{
			    						htn2_active_rate = comb_wm2_htn2_dbt2_rate - (wm2_active_rate + dbt2_active_rate);
			    					}		    					
		    					}
			    			}
							htn2_active_price = htn2_active_price + (rs_quantity*htn2_active_rate);
			    		...
			    		if(rs_dbt == 1){
			    			...
			    			if (dbt2_active_rate == 0.0)
		    				{
			    				if (rs_wm == 1 && rs_htn == 1)
		    					{
			    					if(wm2_active_rate > 0.0 && htn2_active_rate > 0.0)
			    					{
			    						dbt2_active_rate = comb_wm2_htn2_dbt2_rate - (wm2_active_rate + htn2_active_rate);	
			    					}	    					
		    					}
			    			}
							dbt2_active_price = dbt2_active_price + (rs_quantity*dbt2_active_rate);
		    	...
		    	if(rs_sku.match(/htn/g) && rs_sku.match(/dbt/g) && rs_sku.match(/bh/g) && rs_sku.match(/pppm/g)){
		    		...
		    		if(rs_htn == 1){
		    			...
		    			if (htn_active_rate == 0.0)
	    				{
		    				if (rs_dbt == 1 && rs_bh == 1)
	    					{
		    					if(dbt_active_rate > 0.0 && bh2_active_rate > 0.0)
		    					{
		    						htn_active_rate = comb_htn_dbt_bh2_rate - (dbt_active_rate + bh2_active_rate);
		    					}		    					
	    					}
		    			}
						htn_active_price = htn_active_price + (rs_quantity*htn_active_rate);
		    		...
		    		if(rs_dbt == 1){
		    			...
		    			if (dbt_active_rate == 0.0)
	    				{
		    				if (rs_htn == 1 && rs_bh == 1)
	    					{
		    					if(htn_active_rate > 0.0 && bh2_active_rate > 0.0)
		    					{
		    						dbt_active_rate = comb_htn_dbt_bh2_rate - (htn_active_rate + bh2_active_rate);	
		    					}	    					
	    					}
		    			}
						dbt_active_price = dbt_active_price + (rs_quantity*dbt_active_rate);
		    		...
		    		if(rs_bh == 1){
		    			...
		    			if (bh2_active_rate == 0.0)
	    				{
	    					...
	    					{
		    					if(htn_active_rate > 0.0 && dbt_active_rate > 0.0){
		    						bh2_active_rate = comb_htn_dbt_bh2_rate - (htn_active_rate + dbt_active_rate);	
		    					}
	    					}
		    			}
						bh2_active_price = bh2_active_price + (rs_quantity*bh2_active_rate);
			    	...
			    	if(rs_sku == 'pd_phase2_htn_dbt_pppm' || rs_sku == 'pd_htn_phase2_dbt_pppm' || rs_sku == 'pd_htn_dbt_phase2_pppm'
			    		...
			    		if(rs_pd == 1){
			    			...
			    			if (pd2_active_rate == 0.0)
		    				{
		    					...
		    					{
			    					if(htn2_active_rate > 0.0 && dbt2_active_rate > 0.0){
			    						pd2_active_rate = comb_pd2_htn2_dbt2_rate - (htn2_active_rate + dbt2_active_rate);	
			    					}
		    					}
			    			}
							pd2_active_price = pd2_active_price + (rs_quantity*pd2_active_rate);
			    		...
			    		if(rs_htn == 1){
			    			...
			    			if (htn2_active_rate == 0.0)
		    				{
			    				if (rs_pd == 1 && rs_dbt == 1)
		    					{
			    					if(pd2_active_rate > 0.0 && dbt2_active_rate > 0.0)
			    					{
			    						htn2_active_rate = comb_pd2_htn2_dbt2_rate - (pd2_active_rate + dbt2_active_rate);
			    					}		    					
		    					}
			    			}
							htn2_active_price = htn2_active_price + (rs_quantity*htn2_active_rate);
			    		...
			    		if(rs_dbt == 1){
			    			...
			    			if (dbt2_active_rate == 0.0)
		    				{
			    				if (rs_pd == 1 && rs_htn == 1)
		    					{
			    					if(pd2_active_rate > 0.0 && htn2_active_rate > 0.0)
			    					{
			    						dbt2_active_rate = comb_pd2_htn2_dbt2_rate - (pd2_active_rate + htn2_active_rate);	
			    					}	    					
		    					}
			    			}
							dbt2_active_price = dbt2_active_price + (rs_quantity*dbt2_active_rate);
		    	...
		    	if(rs_sku.match(/wm/g) && rs_sku.match(/pd/g) && rs_sku.match(/dbt/g) && rs_sku.match(/pppm/g)){
			    	...
			    	if(rs_sku == 'wm_phase2_pd_dbt_pppm' || rs_sku == 'wm_pd_phase2_dbt_pppm' || rs_sku == 'wm_pd_dbt_phase2_pppm'
			    		 || rs_sku == 'wm_phase2_pd_phase2_dbt_pppm' || rs_sku == 'wm_pd_phase2_dbt_phase2_pppm' || rs_sku == 'wm_phase2_pd2_dbt_phase2_pppm'
			    		...
			    		if(rs_pd == 1){
			    			//log.debug('rs_pd == 1');
			    			pd2_active_quantity = pd2_active_quantity + rs2_quantity;
			    			pd2_active_quantity_bundle = pd2_active_quantity_bundle + rs_quantity;
							pd2_active_price = pd2_active_price + (rs_quantity*pd2_active_rate);
			    		}
