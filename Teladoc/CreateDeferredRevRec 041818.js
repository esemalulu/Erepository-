  		...
  		if(arrResult)
  		{
    		for (var i = 0;  i < arrResult.length; i++)

      		{
                ...
                deferredrevid = createRec(customrecord, p_deferredrevacct, p_contraaccount, p_account ) ;   
...
function createRec(customrecord,p_deferredrevacct, p_contraaccount, p_account)
/********************************************************************************************/
