...
//last update date: 01/05/17 - NS-105
//last update date: 111618 - NS-236 
//07/08/2020: Added searchAllRecord function
...
function CreateVendorBill()
{
 try
 {
  ...
  arrFilter[2] = new nlobjSearchFilter('custrecord_liv_pcomm_bill_amt', null, 'greaterthan',  0 ); 
  ...
  arrColumns.push(new nlobjSearchColumn('custrecord_liv_pcomm_ns_contract_number'));  //111618
  ...
  var arrResult = searchAllRecord('customrecord_liv_partners_comm', null, arrFilter, arrColumns);
  
  nlapiLogExecution('DEBUG', 'Value arrresult',+arrResult.length);
...
/********************************************************************************************/
{
	nlapiLogExecution('DEBUG', 'ACTIVITY', 'createBillRec Started...');
        ...
        var contractnumber = customrecord.getValue('custrecord_liv_pcomm_ns_contract_number');
		...
		try
		{
	     ...
	     {  
            ...
            record.setCurrentLineItemValue('expense','custcol_liv_partner_fee', billrate);  //NS-105
            record.setCurrentLineItemText('expense','custcol_liv_invoice_client_code', clientcode); //111618
            record.setCurrentLineItemValue('expense','custcol_liv_sol_contract_number', contractnumber);
