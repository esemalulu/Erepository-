          ...
          for (var i = 0;  i < arrResult.length; i++)
           {
             ...
             var expensedept = custrecord.getValue('custentity_liv_expense_dept');
              ...
              // Update customer record with cumulative enrollment
              	...
              	updaterec.setFieldValue('custentity_liv_jira_key', jira_key); //NS-146
              	updaterec.setFieldValue('custentity_liv_sign_date', sign_date); //NS-146
              	updaterec.setFieldValue('custentity_liv_launch_date', launch_date); //NS-146
              	updaterec.setFieldText('custentity_liv_client_type', client_type); //NS-146
              	updaterec.setFieldValue('custentity_liv_enrollment_method', enrollment_method); //NS-146
              	updaterec.setFieldValue('custentity_liv_eligible_pwds', eligible_pwds); //NS-146
              	updaterec.setFieldValue('custentity_liv_current_enrolled', current_enrolled); //NS-214
