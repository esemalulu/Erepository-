...
//04292020 - Added appendClientCode function to fix duplicate client code.
...
function CreateInvoice()
{
 try
 {
  ...
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dmwm_active_members_qty'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dmwm_program_amt'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dmwm_discount_amt'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dpphtn_active_members_qty'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dpphtn_program_amt'));
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_dpphtn_discount_amt'));
  ...
  // WM & DPP
  arrColumns.push(new nlobjSearchColumn('custrecord_bs2_ns_wm_admin_fee'));
...
/********************************************************************************************/
{
	nlapiLogExecution('DEBUG', 'ACTIVITY', 'createInvoiceRec Started...');
        ...
        var upfrontmeters = nvl(customrecord.getValue('custrecord_bs2_upfront_meter_qty'),0) ;
        var replmeters = nvl(customrecord.getValue('custrecord_bs2_repl_meter_qty'),0) ;
        var lapsedmembers = nvl(customrecord.getValue('custrecord_bs2_lapsed_members_qty'),0) ;
        var earlytermtotal = nvl(customrecord.getValue('custrecord_bs2_early_term_total'),0) ;
        ...
        var pppmprice = nvl(customrecord.getValue('custrecord_bs2_ns_pppm_price'),0);
        var replprice = nvl(customrecord.getValue('custrecord_bs2_ns_replace_price'),0);
        var upfrontprice = nvl(customrecord.getValue('custrecord_bs2_ns_upfront_price'),0);
        ...
        var htnearlytermtotal = nvl(customrecord.getValue('custrecord_bs2_htn_early_term_total'),0) ;
       ...
       //Tax Line
        ...
        var wmpppmprice = nvl(customrecord.getValue('custrecord_bs2_ns_wm_pppm_price'),0);
        var wmreplprice = nvl(customrecord.getValue('custrecord_bs2_ns_wm_replace_price'),0);
        ...
        var wmprogqty = nvl(customrecord.getValue('custrecord_bs2_wm_active_members_qty'),0);
        var wmreplqty = nvl(customrecord.getValue('custrecord_bs2_ns_wm_repl_meter_qty'),0) ;
        var wmearlytermtotal = nvl(customrecord.getValue('custrecord_bs2_wm_early_term_total'),0) ;
        var wmtermamt = nvl(customrecord.getValue('custrecord_bs2_ns_wm_term_amt'),0) ;


        //DPP

        var dpppppmprice = nvl(customrecord.getValue('custrecord_bs2_ns_dpp_pppm_price'),0);
        var dppreplprice = nvl(customrecord.getValue('custrecord_bs2_ns_dpp_replace_price'),0);
        ...
        var dppprogqty = nvl(customrecord.getValue('custrecord_bs2_dpp_active_members_qty'),0);
        var dppreplqty = nvl(customrecord.getValue('custrecord_bs2_ns_dpp_repl_meter_qty'),0) ;
        var dppearlytermtotal = nvl(customrecord.getValue('custrecord_bs2_dpp_early_term_total'),0) ;
        var dpptermamt = nvl(customrecord.getValue('custrecord_bs2_ns_dpp_term_amt'),0) ;
        ...
        var htnprogqty = nvl(customrecord.getValue('custrecord_bs2_htn_active_members_qty'),0);
        var htnpppmprice = nvl(customrecord.getValue('custrecord_bs2_ns_htn_pppm_price'),0);

        //Combined quantities
        var cbprogqty = nvl(customrecord.getValue('custrecord_bs2_cb_active_members_qty'),0);
        var dmwmprogqty = nvl(customrecord.getValue('custrecord_bs2_dmwm_active_members_qty'),0);
        var dpphtnprogqty = nvl(customrecord.getValue('custrecord_bs2_dpphtn_active_members_qty'),0);
        var dmhtnwmprogqty = nvl(customrecord.getValue('custrecord_bs2_dmhtnwm_active_members_qty'),0);

        //
        var cbdiscountamt = nvl(customrecord.getValue('custrecord_bs2_cb_pppm_discount_amt'),0) ;
        var cbdiscountprice = nvl(customrecord.getValue('custrecord_bs2_cb_pppm_discount_price'),0) ;
        ...
        var cbdmhtnprogamt = nvl(customrecord.getValue('custrecord_bs2_dmhtn_program_amt'),0) ; //NS-287
        ...
        var htnreplqty = nvl(customrecord.getValue('custrecord_bs2_ns_htn_repl_meter_qty'),0);
        var htnreplprice = nvl(customrecord.getValue('custrecord_bs2_ns_htn_replace_price'),0);
              ...
              // if (nvl(cbdiscountprice,'NA') != 'NA')
               ...
               else
               {
                  ...
                  if (cbdiscountamt != 0) //dm & htn
                  {
                      ...
                      record.selectNewLineItem('item');
	                  record.setCurrentLineItemValue('item','item',cbdiscountitem);
                      record.setCurrentLineItemValue('item', 'description', 'Diabetes & Hypertension Program Bundle Discount '+cbdiscountpct+'%.'); //NS-287
                      record.setCurrentLineItemValue('item', 'quantity', cbprogqty);
                      record.setCurrentLineItemText('item', 'price', 'Custom');
                      //record.setCurrentLineItemValue('item', 'rate', 1);
                      record.setCurrentLineItemValue('item', 'amount', cbdiscountamt);  //NS-287
                  ...
                  if (dmwmdiscountamt != 0) //dm & wm
                  {
                      ...
                      record.selectNewLineItem('item');
	                  record.setCurrentLineItemValue('item','item',cbdiscountitem);
                      record.setCurrentLineItemValue('item', 'description', 'Diabetes & Weight Management Program Bundle Discount '+cbdiscountpct+'%.'); //NS-287
                      record.setCurrentLineItemValue('item', 'quantity', dmwmprogqty);
                      record.setCurrentLineItemText('item', 'price', 'Custom');
                      //record.setCurrentLineItemValue('item', 'rate', 1);
                      record.setCurrentLineItemValue('item', 'amount', dmwmdiscountamt);  //NS-287
                      record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                      record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                      record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                      record.setCurrentLineItemValue('item', 'custcol_liv_gross_amount',dmwmprogamt );
                      record.commitLineItem('item');
                   }
                  if (dpphtndiscountamt != 0) //dpp & htn
                  {
                      ...
                      record.selectNewLineItem('item');
	                  record.setCurrentLineItemValue('item','item',cbdiscountitem);
                      record.setCurrentLineItemValue('item', 'description', 'DPP & Hypertension Program Bundle Discount '+cbdiscountpct+'%.'); //NS-287
                      record.setCurrentLineItemValue('item', 'quantity', dpphtnprogqty);
                      record.setCurrentLineItemText('item', 'price', 'Custom');
                      //record.setCurrentLineItemValue('item', 'rate', 1);
                      record.setCurrentLineItemValue('item', 'amount', dpphtndiscountamt);  //NS-287
                      record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                      record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                      record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                      record.setCurrentLineItemValue('item', 'custcol_liv_gross_amount',dpphtnprogamt );
                      record.commitLineItem('item');
                   }
                  if (dmhtnwmdiscountamt != 0) //dm & htn & wm
                  {
                      nlapiLogExecution('DEBUG', 'VALUE', 'dmhtnwmdiscountamt : '+dmhtnwmdiscountamt);
                      record.selectNewLineItem('item');
	                  record.setCurrentLineItemValue('item','item',cbdiscountitem);
                      record.setCurrentLineItemValue('item', 'description', 'Diabetes, Hypertension & Weight Managemnet Program Bundle Discount '+cbdiscountpct+'%.'); //NS-287
                      record.setCurrentLineItemValue('item', 'quantity', dmhtnwmprogqty);
                      record.setCurrentLineItemText('item', 'price', 'Custom');
                      //record.setCurrentLineItemValue('item', 'rate', 1);
                      record.setCurrentLineItemValue('item', 'amount', dmhtnwmdiscountamt);  //NS-287
                      record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode);
                      record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                      record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                      record.setCurrentLineItemValue('item', 'custcol_liv_gross_amount',dmhtnwmprogamt );
                      record.commitLineItem('item');
                   }
               }
