...
function(file, task, runtime, search, email) {
    function execute(scriptContext) {
    	try{
	    	...
	    	var sftpRSBillingFilenameId = runtime.getCurrentScript().getParameter("custscript_sftp_rs_billing_filename");
	    	log.debug({title: 'execute', details: 'sftpRSBillingFilenameId = '+sftpRSBillingFilenameId});
	    	
	    	var sftpRSBillingFilename = '';
	    	if(sftpRSBillingFilenameId == 1)
	    		sftpRSBillingFilename = 'Billing_Snapshot';
	    	else if(sftpRSBillingFilenameId == 2)
	    		sftpRSBillingFilename = 'CC_Val';
          	else if(sftpRSBillingFilenameId == 3)
    			sftpRSBillingFilename = 'ns_bill';
			...
			//File name format: Billing_Snapshot_YYYY_MM_DD.csv  CC_Val_YYYY_MM_DD.csv 
			var rsBillingFilename = sftpRSBillingFilename + "_" + formattedDate+'.csv'; // eg. Billing_snapshot_2020_08_01
