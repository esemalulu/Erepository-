...
function beforeSubmit(type)
{
  ...
  if ( (type == 'create') &&  (nlapiGetContext().getExecutionContext() == 'csvimport'))
  {
      ...
      var period = nlapiGetFieldValue('custrecord_liv_enrm_period_2');
      var contractnumber = nlapiGetFieldValue('custrecord_liv_enrm_contract_number_2');
      var program = nlapiGetFieldValue('custrecord_liv_enrm_program_2');
	   ...
	   arrFilter[0] = new nlobjSearchFilter('custrecord_liv_enrm_period_2', null, 'is',  period ); 
	   arrFilter[1] = new nlobjSearchFilter('custrecord_liv_enrm_contract_number_2', null, 'is',  contractnumber ); 
	   arrFilter[2] = new nlobjSearchFilter('custrecord_liv_enrm_program_2', null, 'is',  program ); 

	    //Define search columns
	
	    var arrColumns = new Array();
		arrColumns.push(new nlobjSearchColumn('custrecord_liv_enrm_period_2'));
	   
	    //Execute search
	    
		var arrResult = nlapiSearchRecord('customrecord_liv_enrollment_2', null, arrFilter, arrColumns);
       ...
       if(arrResult) //  found - delete records first
        {
           ...
           nlapiDeleteRecord('customrecord_liv_enrollment_2', rec_id);
...
{   
      ...
      var clientcode = nlapiGetFieldValue('custrecord_liv_enrm_client_code_2');
      var period = nlapiGetFieldValue('custrecord_liv_enrm_period_2');
      var mtd_enrollees = nlapiGetFieldValue('custrecord_liv_enrm_mtd_enrollees_2');
      var ltd_enrollees = nlapiGetFieldValue('custrecord_liv_enrm_cum_enrollees_2');
      var jira_key = nlapiGetFieldValue('custrecord_liv_enrm_jira_key_2'); //NS-146
      var sign_date = nlapiGetFieldValue('custrecord_liv_enrm_sign_date_2'); //NS-146
      var launch_date = nlapiGetFieldValue('custrecord_liv_enrm_launch_date_2'); //NS-146
      var enrollment_method = nlapiGetFieldValue('custrecord_liv_enrm_enrollment_method_2'); //NS-146
      var client_type = nlapiGetFieldValue('custrecord_liv_enrm_client_type_2'); //NS-146
      var eligible_pwds = nlapiGetFieldValue('custrecord_liv_enrm_eligible_pwds_2'); //NS-146
      var current_enrolled = nlapiGetFieldValue('custrecord_liv_enrm_current_enrolled_2'); //NS-214
      var contractnumber = nlapiGetFieldValue('custrecord_liv_enrm_contract_number_2');
          ...
          for (var i = 0;  i < arrResult.length; i++)
           {
             ...
             var clienttype        = custrecord.getText(columns[23]);
             var billtocustomer    = custrecord.getValue(columns[20]);
             var soldtocustomer    = custrecord.getValue(columns[21]);
             var pricingmodel      = custrecord.getValue(columns[25]);
             var clientcode      = custrecord.getText(columns[3]);
             var htnprice         = custrecord.getValue(columns[58]);
             var contractstatus         = custrecord.getValue(columns[83]);
    
       
               nlapiLogExecution('DEBUG', 'VALUE', 'Client Code Text: '+clientcode);  
              ...
              nlapiSetFieldValue('custrecord_liv_enrm_ns_customer_2', billtocustomer);
              nlapiSetFieldValue('custrecord_liv_enrm_ns_st_customer_2', soldtocustomer);
              nlapiSetFieldValue('custrecord_liv_enrm_ns_category_2', pricingmodel);
              nlapiSetFieldValue('custrecord_liv_enrm_ns_client_type_2', clienttype); 
              nlapiSetFieldValue('custrecord_liv_enrm_ns_pppm_price_2', Math.abs(parseFloat(bundleprice)));
              nlapiSetFieldValue('custrecord_liv_enrm_ns_upfront_price_2', Math.abs(parseFloat(upfrontprice)));
              nlapiSetFieldValue('custrecord_liv_enrm_ns_htn_pppm_price_2', Math.abs(parseFloat(htnprice)));
              nlapiSetFieldValue('custrecord_liv_enrm_client_code_2', clientcode);
              nlapiSetFieldValue('custrecord_liv_enrm_contract_status_2', contractstatus);
