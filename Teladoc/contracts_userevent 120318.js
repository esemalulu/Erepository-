...
function beforeSubmit(type)
{
  ...
  if ((nlapiGetContext().getExecutionContext() == 'suitelet'))
  {
     ...
     var itemname = nlapiGetFieldValue('custrecord_liv_cm_sf_program_item');
     //var salesprice = nlapiGetFieldValue('custrecord_liv_cm_sales_price');
     var salesprice = nlapiGetFieldValue('custrecord_liv_cm_dia_pppm_price');
     
     if (itemname = 'Livongo (DP)')
     {
        nlapiLogExecution('DEBUG','recordid ', recordid);
        nlapiLogExecution('DEBUG','itemname ', itemname);
        nlapiLogExecution('DEBUG','salesprice ', salesprice);
        nlapiSetFieldValue('custrecord_liv_cm_dia_pppm_price', salesprice);
        nlapiSetFieldValue('custrecord_liv_cm_early_term_pppm_price', salesprice);
     } 
     if (itemname = 'Livongo HTN (DP)')
     {
        nlapiLogExecution('DEBUG','recordid ', recordid);
        nlapiLogExecution('DEBUG','itemname ', itemname);
        nlapiLogExecution('DEBUG','salesprice ', salesprice);
        nlapiSetFieldValue('custrecord_liv_cm_htn_pppm_price', salesprice);
        nlapiSetFieldValue('custrecord_liv_cm_htn_early_term_pppm', salesprice);
     } 
