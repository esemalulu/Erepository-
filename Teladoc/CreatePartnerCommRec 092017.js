 ...
 try
 {
      ...
      //Search custom billing summary
       ...
       // var p_date = nlapiGetContext().getSetting('SCRIPT', 'custscript_date') ;
      	...
      	arrFilter[0] = new nlobjSearchFilter('custrecord_liv_bs_ns_create_partner_bill', null, 'is',  'T' ); 
      	arrFilter[1] = new nlobjSearchFilter('custrecord_liv_bs_ns_partner_comm_id', null, 'isempty',  'null' ); 
      ...
      //	arrFilter[1] = new nlobjSearchFilter('custrecord_liv_bs_date', null, 'is', nlapiGetContext().getSetting('SCRIPT', 'custscript_date')  ); 
       ...
       //Define search columns
       	...
       	arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_partner').setSort(false));
       	...
       	arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_ns_create_partner_bill'));
       	arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_ns_partner_fee'));
       	arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_ns_partner_exp_acct'));
  		arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_ns_partner_terms'));
  		arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_ns_vendor_bill_prefix'));
  		arrColumns.push(new nlobjSearchColumn('custrecord_liv_bs_ns_invoice_members_qty'));
...
/********************************************************************************************/
{
	nlapiLogExecution('DEBUG', 'ACTIVITY', 'createRec Started...');
	    ...
	    var today = new Date();
	     ...
	     var arinvoice = customrecord.getValue('custrecord_liv_bs_ns_invoice_number');
         var arinvoiceid = customrecord.getValue('custrecord_liv_bs_ns_internal_id');
         var arcustomer = customrecord.getValue('custrecord_liv_bs_ns_customer');
         var arclientcode = customrecord.getValue('custrecord_liv_bs_client_code');
         var arinvoicedate = customrecord.getValue('custrecord_liv_bs_date');
         var createbill = customrecord.getValue('custrecord_liv_bs_ns_create_partner_bill');
         var vendorid = customrecord.getValue('custrecord_liv_bs_partner');
         var billrate = customrecord.getValue('custrecord_liv_bs_ns_partner_fee');
         var billexpacct = customrecord.getValue('custrecord_liv_bs_ns_partner_exp_acct');
         var billterms = customrecord.getValue('custrecord_liv_bs_ns_partner_terms');
         var billprefix = customrecord.getValue('custrecord_liv_bs_ns_vendor_bill_prefix');
         var billqty = customrecord.getValue('custrecord_liv_bs_ns_invoice_members_qty');
