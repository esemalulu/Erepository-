 ...
 * 1.01       24 Nov 2020     ginfante  Removed As of Date filter and added To and From date filter
...
function setFilters(objCIConfig, objfilters, arrFilters/*, arrSelectedInvoices*/)
{
    ...
    if (!isEmpty(objfilters.todate) && !isEmpty(objfilters.fromdate)) {
        arrFilters.push(new nlobjSearchFilter("trandate", null, "within", objfilters.fromdate, objfilters.todate));
    }
