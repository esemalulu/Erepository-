        ...
        if(arrResult)
        {
         ...
         //    combprogramdesc = combprogramdesc + ' - ' + convertdate(billing_date, 'MONTHYY') + ' ('+grouping+' )'; 
             ...
             else
             {
              ...
              nlapiSetFieldValue('custrecord_bs2_ns_dpp_admin_fee_amt', dppreferralamt );
              nlapiSetFieldValue('custrecord_bs2_ns_dpp_program_amt', dppprogramamt );
              nlapiSetFieldValue('custrecord_bs2_ns_dpp_term_amt', dppearlytermtotalamt );
              nlapiSetFieldValue('custrecord_bs2_dpp_program_desc', dppprogitemdesc );
