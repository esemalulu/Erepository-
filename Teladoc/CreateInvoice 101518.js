...
//last update date: 101518 - Ns226 - Billing Script enhancements / default 'Custom' price level to all lines
...
/********************************************************************************************/
{
	nlapiLogExecution('DEBUG', 'ACTIVITY', 'createInvoiceRec Started...');
        ...
        //NS-106 FFS
        var ffsprogfee = customrecord.getValue('custrecord_liv_bs_ffs_program_fee');
            ...
            */
	        ...
	        // Upfront Meter
	          ...
	          { 
                 ...
                 record.setCurrentLineItemText('item', 'price', 'Custom'); //101718
                 record.setCurrentLineItemValue('item', 'rate', upfrontprice ); //NS-226
                 record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); // NS-140
                 record.commitLineItem('item'); 
              }
              //NS-159
               ...
               var htnupfrontprice = customrecord.getValue('custrecord_liv_ns_htn_upfront_price');  
	          ...
	          { 
                 ...
                 record.setCurrentLineItemText('item', 'price', 'Custom'); //101718
                 record.setCurrentLineItemValue('item', 'rate', htnupfrontprice ); //NS-226
                 record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); // NS-140
                 record.commitLineItem('item'); 
              }
