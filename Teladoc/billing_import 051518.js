...
{   
      ...
      var combearlyterm1 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_1mon') ;
      var combearlyterm2 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_2mon') ;
      var combearlyterm3 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_3mon') ;
      var combearlyterm4 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_4mon') ;
      var combearlyterm5 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_5mon') ;
      var combearlyterm6 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_6mon') ;
      var combearlyterm7 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_7mon') ;
      var combearlyterm8 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_8mon') ;
      var combearlyterm9 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_9mon') ;
      var combearlyterm10 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_10mon') ;
      var combearlyterm11 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_11mon') ;
      var combearlyterm12 = nlapiGetFieldValue('custrecord_liv_bs_cb_early_term_12mon') ;
          ...
          for (var i = 0;  i < arrResult.length; i++)
           {
             ...
             var combtermprice = custrecord.getValue('custentity_liv_combo_early_term_item') ;
              ...
              if (categorytext == 'Bundled')
              {
               ...
               if (nvl(flattermprice,0) == 0)
                ...
                //
                 ...
                 var totalbillingamt = (nvl(programamt,0))+ (nvl(replamt,0)) + (nvl(referralamt,0)) + (nvl(earlytermtotal,0))+(nvl(htnprogramamt,0))+(nvl(htnreplamt,0))+(nvl(htnreferralamt,0))+(nvl(htnearlytermtotalamt,0));
