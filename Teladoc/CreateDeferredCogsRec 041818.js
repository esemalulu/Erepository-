  		...
  		if(arrResult)
  		{
    		for (var i = 0;  i < arrResult.length; i++)

      		{
                ...
                deferredcogsid = createRec(customrecord, p_deferredcogsacct, p_contraaccount, p_account ) ;   
...
function createRec(customrecord,p_deferredcogsacct, p_contraaccount, p_account)
/********************************************************************************************/
