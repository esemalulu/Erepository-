...
function processRecords(type, discountitem)
{
	  ...
	  var bh2pepmprice = nvl(nlapiGetFieldValue('custrecord_bs2_bh2_pepm_program_price'),0);  // BH2 PROGRAM PEPM PRICE
          ...
          for (var i = 0;  i < arrResult.length; i++)
           {
               ...
               var dppwpitemdesc   = results.getValue(columns[117]); //DPP WP Item
			   ...
			   */
               ...
               nlapiSetFieldValue('custrecord_bs2_bh2_pepm_program_item',bhpepmprogitem);//NS BH PEPM ITEM
               nlapiSetFieldValue('custrecord_bs2_bh2_pepm_prog_item_desc',bhpepmprogitemdesc);//NS BH PEPM ITEM DESC
