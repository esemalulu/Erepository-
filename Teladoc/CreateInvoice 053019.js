		...
		try
		{
	     ...
	     {  
            ...
            if (nvl(wmprogqty,0) > 0)
            {
               ...
               record.setCurrentLineItemValue('item', 'description', wmprogdesc);
               record.setCurrentLineItemValue('item', 'quantity', wmprogqty);
               record.setCurrentLineItemText('item', 'price', 'Custom'); //101718
               record.setCurrentLineItemValue('item', 'rate', wmpppmprice);
               record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
               record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
               record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
               record.commitLineItem('item');
            ...
            if (nvl(dppprogqty,0) > 0)
            {
               ...
               record.setCurrentLineItemValue('item', 'description', dppprogdesc);
               record.setCurrentLineItemValue('item', 'quantity', dppprogqty);
               record.setCurrentLineItemText('item', 'price', 'Custom'); //101718
               record.setCurrentLineItemValue('item', 'rate', dpppppmprice);
               record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
               record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
               record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
               record.commitLineItem('item');
...
//Begin Alex
    ...
    //End Alex
            ...
            if (nvl(wmreplqty,0) > 0)
            {
                ...
                record.setCurrentLineItemValue('item', 'description', wmrepldesc);
                record.setCurrentLineItemValue('item', 'quantity', wmreplqty);
                record.setCurrentLineItemText('item', 'price', 'Custom'); 
                record.setCurrentLineItemValue('item', 'rate', wmreplprice ); 
                record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
                record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                record.commitLineItem('item'); 
            ...
            if (nvl(dppreplqty,0) > 0)
            {
                ...
                record.setCurrentLineItemValue('item', 'description', dpprepldesc);
                record.setCurrentLineItemValue('item', 'quantity', dppreplqty);
                record.setCurrentLineItemText('item', 'price', 'Custom'); 
                record.setCurrentLineItemValue('item', 'rate', dppreplprice ); 
                record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
                record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                record.commitLineItem('item'); 
	        ...
	        if (category == 'Bundled')
	        {
	          ...
	          nlapiLogExecution('DEBUG', 'VALUE', 'Inside Bundled Category (Termination): '+category);
                ...
                if (nvl(earlytermtotal,0) > 0)
                {
                   ...
                   record.setCurrentLineItemText('item', 'price', 'Custom'); 
                   record.setCurrentLineItemValue('item', 'rate', termprice  ); 
                ...
                if (nvl(htnearlytermtotal,0) > 0)
                {
                   ...
                   record.setCurrentLineItemText('item', 'price', 'Custom'); 
                   record.setCurrentLineItemValue('item', 'rate', htntermprice  ); 
                ...
                if (nvl(wmearlytermtotal,0) > 0)
                {
                   ...
                   record.setCurrentLineItemValue('item', 'description', wmtermdesc);
                   record.setCurrentLineItemValue('item', 'quantity', wmearlytermtotal);
                   record.setCurrentLineItemText('item', 'price', 'Custom'); 
                   record.setCurrentLineItemValue('item', 'rate', wmtermprice  ); 
                   record.setCurrentLineItemValue('item', 'amount', Math.abs(parseFloat(wmtermamt)));
                   record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
                   record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                   record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                   record.commitLineItem('item'); 
                ...
                if (nvl(dppearlytermtotal,0) > 0)
                {
                   ...
                   record.setCurrentLineItemValue('item', 'description', dpptermdesc);
                   record.setCurrentLineItemValue('item', 'quantity', dppearlytermtotal);
                   record.setCurrentLineItemText('item', 'price', 'Custom'); 
                   record.setCurrentLineItemValue('item', 'rate', dpptermprice  ); 
                   record.setCurrentLineItemValue('item', 'amount', Math.abs(parseFloat(dpptermamt)));
                   record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
                   record.setCurrentLineItemValue('item', 'custcol_liv_sol_contract_number', contractnumber);
                   record.setCurrentLineItemValue('item', 'custcol_liv_sf_opportunity_id', sfopporid);  //NS-269
                   record.commitLineItem('item'); 
