...
try
{
  ...
  if(role==15 || role==1022 ||  role==1031 || role== 1046 || role== 1057  )
  {
     ...
     if(type == 'item')
     {
        ...
        //NETSUITE-414
        var requestordept = nlapiGetFieldValue('custbody_liv_po_requestor_dept') ;
        nlapiSetCurrentLineItemValue('item', 'department', requestordept);
  
        if (role != 1005 && role != 1020)
        {  
