...
//last update date: 12/11/18 - change batch number to list and setfieldvalue
...
function CreateHCStatJournal()
{
 try
 {
	 // Search Stat journal for the same month
       ...
       nlapiLogExecution('DEBUG','param-jebatchnumber: '+jebatchnumber) ;
       ...
       { 
           ...
           { 
               ...
               //var location = results.getValue(columns[4]); 
			  ...
			  // Create statistical journal
			  	try
		        {
		          ...
		          {	  
                    ...
                    statrecord.setFieldText('approvalstatus','Approved');
	                statrecord.setFieldValue('reversaldate',reversaldate);
                    //statrecord.setFieldValue('approved',true);
                   // statrecord.setFieldValue('approvedSpecified',true);
	              ...
	              //Lines
	                ...
	                //statrecord.setCurrentLineItemValue('line', 'location', location); //110618
