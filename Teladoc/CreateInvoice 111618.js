...
/********************************************************************************************/
{
	nlapiLogExecution('DEBUG', 'ACTIVITY', 'createInvoiceRec Started...');
       ...
       //Tax Line
        ...
        var htnreplqty = customrecord.getValue('custrecord_bs2_htn_repl_meter_qty'); 
        ...
        var htnreferralqty = customrecord.getValue('custrecord_bs2_htn_active_members_qty');
	     ...
	     {  
	        ...
	        if ((firstline == true) && (editinvoice == false))
	        {
	            ...
	            record.setFieldValue('subsidiary',subsidiary);  //ns-62
 	            ...
 	            record.setFieldValue('custbody_bs2_record_id',recordid); //ns-103
            ...
            */
             ...
             if (nvl(cbprogqty,0) > 0)
            {
               ...
               record.setCurrentLineItemValue('item', 'quantity', cbprogqty);
               record.setCurrentLineItemText('item', 'price', 'Custom'); 
               record.setCurrentLineItemValue('item', 'rate', (cbdiscountprice * -1));
               record.setCurrentLineItemText('item', 'custcol_liv_invoice_client_code', clientcode); 
               record.commitLineItem('item');
            }
	        ...
	        // Upfront Meter
	          ...
	          { 
	           ...
	           var htnupfrontitem = customrecord.getValue('custrecord_bs2_ns_upfront_item'); 
               var htnupfrontdesc = customrecord.getValue('custrecord_bs2_ns_upfront_d');  
