function updateconvjename() 
{
 try
 {
     ...
     //  arrFilter[0] = new nlobjSearchFilter('custentity_liv_pccode', null, 'anyof',  [pccodeID] );
       ...
       var arrResult = nlapiSearchRecord('transaction','customsearch_liv_update_qb_name_mapped', null, null);
  ...
  /*
      	...
      	arrFilter[0] = new nlobjSearchFilter('custcol_liv_qb_name', null, 'isnotempty',  'null' ); 
      //	arrFilter[1] = new nlobjSearchFilter('tranid', null, 'is',  '34681' ); 
  
       //Define search columns

       	arrColumns.push(new nlobjSearchColumn('internalid'));
       	arrColumns.push(new nlobjSearchColumn('trandate').setSort(false));
       	arrColumns.push(new nlobjSearchColumn('tranid').setSort(false));
  		arrColumns.push(new nlobjSearchColumn('custcol_liv_qb_name'));
  		arrColumns.push(new nlobjSearchColumn('custcol_liv_qb_name_mapped'));
  	    arrColumns.push(new nlobjSearchColumn('account'));
          		   ...
          		   {	
          			...
          			//{
  		                ...
  		                nlapiLogExecution('DEBUG', 'ACTIVITY', 'In arrCustResult');
                           ...
                           jerecord.setLineItemValue('line', 'custcol_liv_qb_name_mapped', x, customername);
                          } // end for
                        } // end arrCustResult
