      ...
      if(arrResult) 
        {
           ...
           nlapiSetFieldValue('custrecord_liv_rev_bt_sf_account_id', nvl(btsalesforceid, manualsalesforceid));
      ...
      if(arrResult) 
        {
           ...
           nlapiSetFieldValue('custrecord_liv_rev_st_sf_account_id', nvl(stsalesforceid, manualsalesforceid));
