...
//last update date: 12/04/18 - add contractnumber
//last update date: 12/11/18 - batchnumber - switch parameter to picklist and setfieldvalue
// 07072020: searchAllRecord function is added
...
function CreateAmortJournal()
{
 try
 {
   ...
   var today = new Date(); 
	...
	arrColumns.push(new nlobjSearchColumn('custrecord_liv_dfc_contract_number'));

 

 
    var previousje = null ;
    var prevcountractnumber = null;
    ...
    var arrResult = searchAllRecord('customrecord_liv_deferred_cogs', null, arrFilter, arrColumns);
    ...
    for (var i = 0;  i < arrResult.length; i++)
      {
             ...
             var contractnumber = customrecord.getValue('custrecord_liv_dfc_contract_number');
	         ...
	         if ((previousje != currentje) & (i !=0))
	         {
                  ...
                  {           
                     ...
                     record.setCurrentLineItemValue('line', 'custcol_liv_sol_contract_number',  prevcontractnumber);
  	...
  	if(arrResult)
    {
        for (var i = 0;  i < arrResult.length; i++)
      {
        ...
        nlapiLogExecution('DEBUG', 'VALUE', 'record id '+recordid);  
	     ...
	     var jeResult = searchAllRecord('journalentry', null, jeFilter, jeColumns);
