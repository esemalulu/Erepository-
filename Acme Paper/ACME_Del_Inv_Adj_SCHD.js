...
//	{
		try
		{
			 var arrSearchResult = largeSavedSearch('customsearch2659');
			    	...
			    	for (var i = 0; i < arrSearchResult.length; i++)
			    	{
			    		try
			    		{
				    		...
				    		if(recordInternalId)
				    		{
				    			...
				    			nlapiDeleteRecord('invoice', recordInternalId);
				    		}
			    		}
			    		catch(error)
			   		 {                     
...
function largeSavedSearch(id)
{
	...
	var recSearch = nlapiLoadSearch('transaction', 'customsearch2659');
