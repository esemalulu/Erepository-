        ...
        var inventoryitemSearchObj = search.create({
            ...
            filters:
                [
                    ...
                    "AND",
                    [
                        ["custitem_sdb_pim_width", "contains", "x"], "OR", 
                        ["custitem_sdb_pim_width", "contains", "/"], "OR", 
                        ["custitem_sdb_pim_height", "contains", "x"], "OR", 
                        ["custitem_sdb_pim_height", "contains", "/"], "OR", 
                        ["custitem_sdb_pim_length", "contains", "x"], "OR", 
                        ["custitem_sdb_pim_length", "contains", "/"], "OR", 
                        ["custitem_sdb_pim_weight", "contains", "x"], "OR", 
                        ["custitem_sdb_pim_weight", "contains", "/"], "OR", 
                        ["custitem_sdb_pim_volume", "contains", "x"], "OR",
                        ["custitem_sdb_pim_volume", "contains", "/"]
                    ]
                ],
            columns:
                [
    ...
    function map(context) {
        try {
            ...
            if (widthField) {
                ...
                if (widthFieldPostFilter&&widthFieldPostFilter.includes("-")) {
            ...
            if (heightField) {
                ...
                if (heightFieldPostFilter&&heightFieldPostFilter.includes("-")) {
            ...
            if (lengthField) {
                ...
                if (lengthField.includes("x")) {
                    ...
                    var splittedStringlengthField = lengthField.split("X");
                    if (splittedStringlengthField[0] && splittedStringlengthField[0].includes('"')) {
                ...
                if (lengthFieldPostFilter && lengthFieldPostFilter.includes("-")) {
