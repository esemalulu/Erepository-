...
function userEventAfterSubmit(type) {
    ...
    try {
        ...
        var lookupList = getLookupList(recID, currentType);
...
function getSearchResults(id, type) {
    ...
    if (type == 'account') {
        ...
        // nlapiLogExecution('DEBUG','accname is', accName);
        //
        var accName = searchResults[0].getValue('displayname');
        nlapiLogExecution('DEBUG','accDisplayName is', accName);

        // if(accName == null || accName == '')
        // {
        //     accName = searchResults[0].getValue('acctname');
        //     nlapiLogExecution('DEBUG','acctname is', accName);
        // }
