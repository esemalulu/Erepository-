 ...
 */
define(['N/log', 'N/query', 'N/record', 'N/runtime'],
    /**
 * @param{log} log
 * @param{query} query
 * @param{record} record
            ...
            for (var i = 0; i < lineCount; i++) {
                ...
                if(boolIsConsignAddress && !intConsignLocation){ // we need to creeate a new Location for this customer
                    try{
                        ...
                        var strLocationName = 'CONS | ' + strMaker(objCustRecord.getValue('companyname')) + ' | ' + strMaker(addressSubrecord.getValue('addr1')) + ' | ' + strMaker(addressSubrecord.getValue('city'));
