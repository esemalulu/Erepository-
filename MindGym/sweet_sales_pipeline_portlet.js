...
function sweet_main(portlet, column) {
  ...
  var financial_year = nlapiGetContext().getSetting('SCRIPT', 'custscript_financial_year');
  var subsidiary = nlapiGetContext().getSetting('SCRIPT', 'custscript_subsidiary');
  ...
  if (subsidiary == 2) {
    ...
    title = title + 'UAE ' + financial_year;
  }
