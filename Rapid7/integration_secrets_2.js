/**
 * integration_secrets_2.js
 * @NApiVersion 2.x
 * @NModuleScope Public
 */
define(['/SuiteScripts/Toolbox/CryptoJS.min.js', 'N/log', 'N/https', 'N/url'], function (CryptoJS, log, https, url) {
    var INTEGRATION_CONSUMER_KEY = '5509886056f528b850931cd8225f3115851ffdf2d0351e78a955f01da4f221cd';
    var INTEGRATION_CONSUMER_SECRET = '0a32a1063c7cd400708ba5262946ccab3b622cae367bd3f4ae9e4052d0806852';
    var INTEGRATION_TOKEN_ID = '75144e5d5e42d86802f32fa7cb936a1ba7113e664ccf9a00fe5033b68ae04711';
    var INTEGRATION_TOKEN_SECRET = '79c499ca5de8985578855f01929605542a339a8c0775ea064b023c7d8216b697';
    ...
    OAuth.prototype.getParameterString = function (request, oauth_data) {
        var base_string_data = this.sortObject(
            this.percentEncodeData(this.mergeObject(oauth_data, this.mergeObject(request.data, this.deParamUrl(request.url))))
        );
    ...
    OAuth.prototype.toHeader = function (oauth_data) {
        ...
        return header_value.substr(0, header_value.length - this.parameter_seperator.length); //cut the last chars
    };
    ...
    function getOAuthHeader(options) {
        ...
        var token = {
            key: INTEGRATION_TOKEN_ID,
            secret: INTEGRATION_TOKEN_SECRET,
        };

        var auth = OAuth({
            realm: getQueryParams(options.url)['compid'],
            consumer: {
                key: INTEGRATION_CONSUMER_KEY,
                secret: INTEGRATION_CONSUMER_SECRET,
            },
    ...
    function callInternalRestlet(options, urlStr) {
        try {
            ...
            var restletRequest = {};
            restletRequest.headers = {
                'Content-Type': 'application/json',
                'Authorization': getOAuthHeader({ url: urlStr, method: 'POST' }),
            };
            restletRequest.url = urlStr;
            restletRequest.body = JSON.stringify(options);

            var restletResponse = https.post(restletRequest);
            ...
            log.error({ title: 'Failed to call internal restlet to perform function ' + options.restletFunction, details: restletError });
        }
    }

    return {
        getOAuthHeader: getOAuthHeader,
        callInternalRestlet: callInternalRestlet
    };
});
