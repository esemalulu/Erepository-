function PageInit(){
if ((nlapiGetFieldText('custeventr7supporttier') == '')){nlapiSetFieldValue('custeventr7supporttier',12);}

if ((nlapiGetFieldText('contact') == '')){
var context = nlapiGetContext();
var contactID = context.getContact();
nlapiSetFieldValue('contact', contactID);
}
}
...
function saveRecord()
{
//custeventr7casecustomerexpresssupport
//custeventr7supporttier 10

//Territory rules are keyed off custeventr7caseproductgroup field
nlapiSetFieldValue('custeventr7caseproductgroup',nlapiGetFieldValue('product'));

if ((nlapiGetFieldValue('custeventr7casecustomerexpresssupport') == 'T')){
nlapiSetFieldValue('custeventr7supporttier',10);
}
