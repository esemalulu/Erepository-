...
function doRecordNew(rec, lc, role)
{
   ...
   {
      if (role == 1029 || role == 1033 || role==1069)
         throw nlapiCreateError(
            'REQUEST_FAILED',
   ...
   switch (ifv)
   {
      ...
      case 3:
         ...
         if (role == 1033 || role == 1029 || role==1069)
            throw nlapiCreateError(
               'REQUEST_FAILED',
      ...
      case 4:
         ...
         if (role != 1029 && role!=1069) // Web services partner account.
            throw nlapiCreateError(
               'REQUEST_FAILED',
               'Invalid license purpose for your role.',
               true);
      ...
      case 5:
         ...
         if (role != 1033 && role!=1069) // Web services partner test account.
            throw nlapiCreateError(
               'REQUEST_FAILED',
               'Invalid license purpose for your role.',
               true);
   ...
   else if (role == 1029 || role == 1033 || role==1069) // OEM customers
   {
      formParams['OEM'] = '1';
   ...
   try
   {
      ...
      response = nlapiRequestURL(
         'https://67.110.152.71:9669/license/generate',
         formParams,
         headers);
   }
   catch (e)
