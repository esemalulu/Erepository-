...
function doRecordNew(rec, lc, role)
{
   ...
   else if (role == 1029 || role == 1033) // OEM customers
   {
  	...
  	//Just performing the validation here
   ...
   try
   {
	...
	nlapiSendEmail(2,'derek_abdine@rapid7.com','XML from licensing server',response.getBody(),new Array('derek_zanga@rapid7.com','suvarshi_bhadra@rapid7.com'));	 
