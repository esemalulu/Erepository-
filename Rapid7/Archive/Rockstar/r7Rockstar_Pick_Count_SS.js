...
function afterSubmit(type){
	...
	if (checkApproved !='F' && type != 'delete') {
		...
		if (toId != null && toId != '') {
			nlapiLogExecution('DEBUG', "---Begin!  toId: " + toId);
			var rockstarInfo = countPicks(toId);
			nlapiLogExecution('DEBUG', " #picks: " + rockstarInfo.pickTotal);
			...
			nlapiLogExecution('DEBUG', "---All Done!-- Submitted IDs: " + submittedIds);
		}
	}
}
