...
define(['/SuiteScripts/RESTlets/Common Library/r7_common_restlet_library.js',
        ...
        function(common_library, error) {
            ...
            var libraries = [];
            libraries.push({vendorId:'ROI',library:'/SuiteScripts/RESTlets/Customer/r7_customer_roi_library.js'});
            libraries.push({vendorId:'SF_OPPSEARCH',library:'/SuiteScripts/RESTlets/Customer/r7_customer_opp_search_service_library.js'});
            libraries.push({vendorId:'SF_LEADRESOLUTION_V1',library:'/SuiteScripts/RESTlets/Customer/r7_lead_resolution_service_library_v1.js'});
            libraries.push({vendorId:'SF_LEADRESOLUTION_V2',library:'/SuiteScripts/RESTlets/Customer/r7_lead_resolution_service_library_v2.js'});
