	...
	if (!caseobj.hasmsgs) {
		...
		for (var m=0; armsg && m < armsg.length; m++) {
			...
			if (msginternalId) {
				...
				if (recEmails != null && recEmails.indexOf(',') > -1 ) {  // GAMA edit - Jan 7, 2012  - Added check for null recipients
					arRecEmails = recEmails.split(',');
				} else if (recEmails != null && recEmails.indexOf(';') > -1 ) { // GAMA edit - Jan 7, 2012  - Added check for null recipients
					arRecEmails = recEmails.split(';');
				} else if (recEmails == null) {   // GAMA addition - Jan 7, 2012  - Added check for null recipients
				...
				if (msg.getFieldValue('subject') == null) { // GAMA addition - Add a subject for internal notes if message subject blank
