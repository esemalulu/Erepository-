	...
	{		
		...
		function getInputData(context) {
			...
			try{				 
				...
				if (isNullOrEmpty(custPalletGroupSavedSearchFromParam) || isNullOrEmpty(palletGroupSearchFromParam) || isNullOrEmpty(folderIdFromParam) || isNullOrEmpty(noPendingTemplateFromParam) || isNullOrEmpty(reportCompleteTemplateFromParam) || isNullOrEmpty(emailSenderFromParam) || isNullOrEmpty(emailReceiverFromParam)) {
		...
		try{
			...
			log.debug(DEBUG_IDENTIFIER,"Remaining governance units: " + scriptObj.getRemainingUsage());
					...
					{			
						...
						log.debug(DEBUG_IDENTIFIER, 'custPalletGroupId: '+custPalletGroupId+' customerName: '+customerName+' customerNumber: '+customerNumber+' itemId: '+itemId+' itemNumber: '+itemNumber+' itemName: '+itemName+' shipDate: '+shipDate);
    ...
    function summarize(summary) {
		...
		var today = new Date();
	     ...
	     log.debug(DEBUG_IDENTIFIER, 'palletGroupSearchFromParam: '+palletGroupSearchFromParam+' folderIdFromParam: '
	    		 +folderIdFromParam+'  noPendingTemplateFromParam: '
