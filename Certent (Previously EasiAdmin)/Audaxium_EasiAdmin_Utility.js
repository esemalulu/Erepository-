...
function getNumOfDays(date1, date2)
{
	...
	d2 = new Date(d2[2], d2[1], d1[0]);

	var d1Milli = parseInt(d1.getTime() / 1000);
	var d2Milli = parseInt(d2.getTime() / 1000);

	var timeDif = d1Milli - d2Milli;

	var timeDifHours = timeDif / 60 / 60;

	numOfDays = timeDifHours / 24;
