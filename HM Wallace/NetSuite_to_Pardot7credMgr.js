...
function pushToPardot(type){
	...
	try {
		...
		//- Department (custentity6) is Professional Sales
		filter.push(new nlobjSearchFilter('custentity6', null, 'anyof',['29']));
...
function initScriptParameters() {
	credMgrId = ctx.getSetting('SCRIPT','custscript_escm');
	pardotCampaignId = ctx.getSetting('SCRIPT','custscript_pardot_campid');
