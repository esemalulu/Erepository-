 ...
 * @returns {Void}
 */
function beforeSubmit_ResetItemSync(type)
{
	try
	{
		var execType = CONTEXT.getExecutionContext();
		var logTitle = ['ResetItemSync', type, execType].join(':');
