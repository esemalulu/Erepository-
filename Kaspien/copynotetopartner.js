 ...
 * @returns {Void}
 */
function copynotetopartner(type){
	...
	try {
		...
		if (type == 'create' || type == 'edit') {
			...
			if (customerId) {
				...
				// Search for notes that have company = customer internal id 
				var searchRecords = nlapiSearchRecord('note',null,filters,columns);
				...
				for (var i in searchRecords) {
					...
					nlapiAttachRecord('note', recId, 'vendor', vendorId);       
