 ...
 * @returns {Void}
 */
function afterSubmitCopyContactsToVendor(type){
	...
	try {
		...
		if (type == 'create' || type == 'edit') {
			...
			if (customerId) {
				...
				var searchRecords = nlapiSearchRecord('contact',null,filters,columns);
				...
				for (var i in searchRecords) {
					...
					nlapiAttachRecord('contact', recId, 'vendor', vendorId, {'field': 'company'});       
