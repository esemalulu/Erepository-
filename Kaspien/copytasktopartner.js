 ...
 * @returns {Void}
 */
function copytasktopartner(type){
	...
	try {
		...
		if (type == 'create' || type == 'edit') {
			...
			if (customerId) {
				...
				var searchRecords = nlapiSearchRecord('task',null,filters,columns);
				...
				for (var i in searchRecords) {
					...
					nlapiAttachRecord('task', recId, 'vendor', vendorId, {'field': 'company'});       
