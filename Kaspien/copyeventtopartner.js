 ...
 * @returns {Void}
 */
function copyeventtopartner(type){
	...
	try {
		...
		if (type == 'create' || type == 'edit') {
			...
			if (customerId) {
				...
				var searchRecords = nlapiSearchRecord('calendarevent',null,filters,columns);
				...
				for (var i in searchRecords) {
					...
					nlapiAttachRecord('calendarevent', recId, 'vendor', vendorId, {'field': 'company'});       
