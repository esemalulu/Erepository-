 ...
 * @date   09/12/24
 * Script File:	veic_ue_invoice.js
 * Script Name:	veic_ue_invoice.js
 * Script Type:	Library
 * Description:	This will be the main User Event for the Invoice Record
 * @NApiVersion 2.1
 * @NModuleScope public
 * History:
 ...
 * 01/15/25   Sergio Arce        Added the date validation between From date and As-Of Date
 * 03/03/25   Sergio Arce        Added Invoice Print Logic
 */
