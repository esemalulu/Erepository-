    ...
    (record, search) => {
        ...
        const map = (mapContext) => {
            try {
                ...
                const refundNo = refundRecord.getValue('checknumber');
                if (refundNo) {
                    log.debug('Setting Refund No', `Refund No: ${refundNo} for Refund Id: ${dealerRefundId}`);
                    refundRecord.setValue('tranid', refundNo);
                    refundRecord.setValue('transactionnumber', refundNo);
                    refundRecord.save();
                } else {
                    log.debug('No Refund No', `No Refund No for Refund Id: ${dealerRefundId}`);
                }
            } catch (e) {
