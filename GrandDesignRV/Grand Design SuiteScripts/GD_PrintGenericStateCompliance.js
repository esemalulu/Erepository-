...
function GetGenericStateComplianceHTML(salesOrderId, state){
var html = '';
var topHTML = '';
var midHTML = '';
	...
	'<table width="100%" cellpadding="0">' +
		...
		'<tr>' +
			'<td align="center" colspan="100" style="font-size:24px">' +
				'<b><i><span padding="0" margin="0" style="border-bottom:1px solid black;">' + state + ' Vehicle Compliance Declaration</span></i></b>' +
			'</td>' +
		'</tr>' +
		'<tr>' +
			'<td>' +
