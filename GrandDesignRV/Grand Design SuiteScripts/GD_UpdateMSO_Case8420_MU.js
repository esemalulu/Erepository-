/**
 * Mass updates for case 8420.
 * 
 * Version    Date            Author           Remarks
 * 1.00       8 Nov 2017     Brian Sutter
 *
 */

/**
 * Fixes the MSO address on unit orders.
 * 
 * @param {String} recType Record type internal id
 * @param {Number} recId Record internal id
 * @returns {Void}
 */
function GD_Case8420_MU(recType, recId)
{
    ...
    try {
    	...
    	nlapiLogExecution('error', 'Error on VCB: ' + recId, err);
    }
