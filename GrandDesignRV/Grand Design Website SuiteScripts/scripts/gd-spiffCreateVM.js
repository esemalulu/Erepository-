 ...
 *
 */
function SpiffCreateViewModel(data) {
    ...
    self.dealerName = parsedData.dealer;
    self.spiffFAQ = parsedData.spiffFAQ;
    ...
    self.filterOptions = ko.observableArray([
        ...
        // new filterOption('applied', 'Fully Applied')
    ]);
...
//    self.ascending = "fa fa-arrow-up";
    ...
    self.columns = ko.observableArray([
        ...
        { property: "unit", header: "Unit ", type: "string", state: ko.observable(self.descending), width: "cell-md" },
        { property: "program", header: "Program ", type: "string", state: ko.observable(""), width: "cell-md" },
	...
	function Spiff(data) {
        ...
        self.salesRepLevel = data.salesRepLevel;
	}
    ...
    self.reloadPage = function () {
        window.location.href = nlapiResolveURL('SUITELET', 'customscriptgd_website2_creditmemo_suite', 'customdeploygd_website2_creditmemo_suite') + '&showclosed=' + self.showClosed();
    };
...
$(document).ready(function() {
    var data = nlapiGetFieldValue('custpage_spiffcreatedata');
    var spiffVM = new SpiffCreateViewModel(data);
