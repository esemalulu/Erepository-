 ...
 *
 */
function CreditMemoViewModel(data) {
    ...
    self.searchOptions = ko.observableArray([
        ...
        new searchOption(2, 'Credit Memo #', 'tranid'),
...
//    self.ascending = "fa fa-arrow-up";
    ...
    self.columns = ko.observableArray([
        ...
        { property: "tranid", header: "Credit Memo # ", type: "number", state: ko.observable(self.descending), width: "cell-md" },
...
$(document).ready(function() {
    var data = nlapiGetFieldValue('custpage_creditmemodata');
    var cmVM = new CreditMemoViewModel(data);
    ko.applyBindings(cmVM);
    window.getVM = function() {return cmVM;};
});
